...
<body>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="<?php echo e(URL::to('/')); ?>"><img src="<?php echo e(asset('frontend/images/home/logo.png')); ?>" alt="" /></a>
						</div>
	...
	<section id="slider"><!--slider-->
		<div class="container">
			<div class="row">
              ...
              ->get();
              $count = 0;
              foreach($slider_info as $slider_info) { ?>
                <?php if($slider_info->slider_id == 1): ?>
                  <li data-target="#slider-carousel" data-slide-to="<?php echo e($count); ?>" class="active"></li>
                  <?php $count++;?>
                <?php else: ?>
                  <li data-target="#slider-carousel" data-slide-to="<?php echo e($count); ?>"></li>
                  <?php $count++;?>
                <?php endif; ?>
              <?php } ?>
						</ol>
              ...
              ->get();
               { ?>
              <?php $__currentLoopData = $slider_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php if($slider_info->slider_id == 1): ?>
							 <div class="item active">
								...
								<div class="col-sm-6">
									<img style="height: 484px; width: 441px;" src="<?php echo e(URL::to($slider_info->slider_image)); ?>" class="girl img-responsive" alt="" />
	...
	<section id="replace_with_loginform">
		<div class="container">
			<div class="row">
				<div id="cat_and_brand" class="col-sm-3">
              ...
              <div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="<?php echo e(URL::to('/product_by_category/'.$all_published_category->category_id)); ?>"><span class="pull-right">(<?php $count_cats = DB::table('tbl_products')
                  ->where('category_id', $all_published_category->category_id)
                  ->get();
                  echo count($count_cats); ?>)</span><?php echo e($all_published_category->category_name); ?></a></h4>
								</div>
							</div>
              <?php }
              ...
              ?>
                  ...
                  foreach($all_published_manufacture as $all_published_manufacture){?>
                  <li><a href="<?php echo e(URL::to('/product_by_manufacture/'.$all_published_manufacture->manufacture_id)); ?>"> <span class="pull-right">(<?php $count_brands = DB::table('tbl_products')
                  ->where('manufacture_id', $all_published_manufacture->manufacture_id)
                  ->get();
                  echo count($count_brands); ?>)</span><?php echo e($all_published_manufacture->manufacture_name); ?></a></li>
                  <?php }
				...
				<div id="cart_design" class="col-sm-9 padding-right">
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © <?php echo e(date('Y')); ?> E-Shopper Inc. All rights reserved.</p>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        if(url.includes('show-cart'))
        {
          $("#slider").hide();
          $("#cat_and_brand").hide();
          $("#cart_design").removeClass('col-sm-9 padding-right');
          $("#cart_design").addClass('col-sm-12 padding-right')
        }
        if(url.includes('login-check'))
        {
          $("#slider").hide();
          $("#cat_and_brand").hide();
          $("#replace_with_loginform").replaceWith($("#form"));
        }
        if(url.includes('checkout'))
        {
          $("#slider").hide();
          $("#cat_and_brand").hide();
          $("#replace_with_loginform").replaceWith($("#cart_items"));
        }
      });
    </script>
</body>
</html>
<?php /**PATH /opt/lampp/htdocs/elaravel/resources/views/layout.blade.php ENDPATH**/ ?>